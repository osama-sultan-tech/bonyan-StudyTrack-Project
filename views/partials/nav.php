            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/subjects.php" class=" <?= urlIs( '/subjects.php') ? 'bg-gray-950/50 text-white ' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Subjects</a>
                        <a href="/notes.php" class=" <?=urlIs( '/notes.php')  ? 'bg-gray-950/50 text-white ' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Notes</a>
                        <a href="/habits.php" class=" <?=urlIs( '/habits.php')  ? 'bg-gray-950/50 text-white ' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Habits</a>
                    </div>
                </div>
            </div>
            <!--                ##################################################  -->
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div x-data="{ open: false }" class="relative ml-3">
                        <div>
                            <button @click="open = !open" @click.away="open = false" type="button" class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500" id="user-menu-button">
                                <span class="absolute -inset-1.5"></span>
                                <span class="sr-only">Open user menu</span>
                                <img src="/images/study-icon.png" alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
                            </button>
                        </div>
